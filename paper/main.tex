...
\end{definition}
which results in DAGs with a collider structure, or a UG with a clique
...
\begin{definition}[$k$-associations]
  ...
  \begin{equation}
    ...
    Y\assoc{\leq k}\rmX,
  \end{equation}
  to denote the existance of some association between $Y$ and some
  subset of $\rmX$,
  $\exists \rmZ \subseteq \rmX : Y\assoc{|\rmZ|}\rmZ$.
\end{definition}
