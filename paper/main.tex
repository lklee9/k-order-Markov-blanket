...
\begin{lemma}[Inverse Weak Union]
...
\begin{algorithm}
  \caption{Find Separator, $\forall \rmS$}
  % \DontPrintSemicolon
  \KwIn{$Y$, $\rmX$, $\rmS$, $\alpha$}
  \KwOut{Output result}
  \Inv{$\rmX \dep{} Y \mid \rmS$}
  \While{$\exists X \in \rmX : Y \indep{} X \mid \rmS \cup \rmX'
    \setminus X$} {
    $\rmX \gets \rmX \setminus X$\;
  }
  \Return{$\rmX$}\;
\end{algorithm}

\begin{algorithm}
  \caption{Find $k$-Associations, $\exists \rmX$}
  % \DontPrintSemicolon
  \KwIn{$Y$, $\rmX$, $\rmS$, $\alpha$}
  \KwOut{Output result}
  \Inv{$\rmX \dep{} Y \mid \rmS$}
...
\begin{algorithm}
  \caption{Filter for Strict Association, $\exists \rmX$}
  % \DontPrintSemicolon
  \KwIn{$Y$, $\rmX$, $\rmS$, $\alpha$}
  \KwOut{Output result}
  \Inv{$\rmX \dep{} Y \mid \rmS$}
...
\begin{algorithm}
  \caption{Is Strict Associated?, $\exists \rmX$}
  % \DontPrintSemicolon
  \KwIn{$Y$, $\rmX$, $\rmS$, $\alpha$}
  \KwOut{Output result}
  \If{$Y \dep{} \rmX \mid \rmS$}{
