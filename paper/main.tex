...
% The \icmltitle you define below is probably too long as a header.
% Therefore, a short form for the running title is supplied here:
\icmltitlerunning{High-Order Markov Blanket Discovery}
...
\twocolumn[
\icmltitle{High-Order Markov Blanket Discovery:\\
...
\texttt{nico.piatkowski@iais.fraunhofer.de}\\
  ...
  \begin{icmlauthorlist}
    \icmlauthor{Loong Kuan Lee}{iais}
    \icmlauthor{Ragavi Krishnamoorthy}{iais}
    \icmlauthor{Allegra Cuzzocera}{it}
    \icmlauthor{Nico Piatkowski}{iais}
  \end{icmlauthorlist}

  \icmlaffiliation{iais}{
    Hybrid Intelligence, Fraunhofer IAIS, Sankt Augustin, Germany
  }
  \icmlaffiliation{it}{
    Department of Physics Ettore Pancini,
    University of Naples Federico II, Naples, Italy}
  \icmlcorrespondingauthor{Loong Kuan Lee}{
    loong.kuan.lee@iais.fraunhofer.de}
  % You may provide any keywords that you find helpful for describing your
  % paper; these are used to populate the "keywords" metadata in the PDF but
  % will not be shown in the document
  \icmlkeywords{Markov Blanket,Bayesian Networks,Markov Random
    Fields,Probabilistic Graphical Models}
